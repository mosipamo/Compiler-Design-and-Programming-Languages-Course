...
//          System.out.println(LINESTRING + cond.getLine() + EXPRSTRING + s);
    ...
    @Override
    public Type visit(ArgumentExpressionList argumentExpressionList) {
    ...
    @Override
    public Type visit(StringLiteralExpression stringLiteralExpression) {
        return null;
    }

    @Override
    public Type visit(PointerType pointerType) {
        return null;
    }

    @Override
    public Type visit(IdentifierDeclarator identifierDeclarator) {
        return null;
    }

    @Override
    public Type visit(DirectDeclarator directDeclarator) {
    ...
    @Override
    public Type visit(AbstractDeclarator abstractDeclaration) {
    ...
    @Override
    public Type visit(JumpStatement jumpStatement) {
...
//        }
    ...
    @Override
    public Type visit(ForExpression forExpression) {
    ...
    @Override
    public Type visit(CommaExpression commaExpression) {
    ...
    @Override
    public Type visit(AssignmentExpression assignmentExpression) {
        String op = "";
...
//        System.out.println(LINESTRING + assignmentExpression.getLine() + EXPRSTRING + op);
    ...
    @Override
    public Type visit(ExternalDeclaration externalDeclaration) {
    ...
    @Override
    public Type visit(ThreeExpression threeExpression) {
