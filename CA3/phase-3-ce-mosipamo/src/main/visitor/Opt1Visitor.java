...
public class Opt1Visitor extends Visitor<Void> {
    private static final Set<String> builtIns = Set.of("printf", "scanf");
    public static final Vector<SymbolTableItem> not_used = new Vector<>();
...
////                        System.out.println("1: " + varItem.getName() + " " + varItem.getLine());
...
//                System.out.print(varItem.getLine());

//                System.out.println(" fuck: " + varItem.getName() + " "+ varItem.getLine());       //get arr declaration
                try {
                    SymbolTable.top.put(varItem);
//                    System.out.println("2: " + varItem.getName() + " " + varItem.getLine());
                    not_used.add(varItem);
                } catch (ItemAlreadyExistsException e) {
...
//            System.out.println("line: "  + item.getLine() + " name: " + item.getName());
...
//            if (binaryExpression.getLeft() instanceof IdentifierExpression) {
////                System.out.println(((IdentifierExpression) binaryExpression.getLeft()).getName() + "*" + ((IdentifierExpression) binaryExpression.getLeft()).getLine());
////                String name = ((IdentifierExpression) binaryExpression.getLeft()).getName();
////                System.out.println(((IdentifierExpression) binaryExpression.getLeft()).getName() + " " + binaryExpression.getLeft().getLine());
//                try {
//                    VariableSymbolTableItem item = (VariableSymbolTableItem) SymbolTable.top.getItem("Variable_" + ((IdentifierExpression) binaryExpression.getLeft()).getName());
//                    item.setVisited(true);
...
//                            anses.add("Line:" + exprName.getLine() + "-> " + ((IdentifierExpression) exprName).getName() + " not declared");
    ...
    public Vector<SymbolTableItem> chap() {
        Vector<SymbolTableItem> f = new Vector<>();

        for (SymbolTableItem s: not_used) {
            if (s instanceof VariableSymbolTableItem) {
                if (((VariableSymbolTableItem) s).getVisited() == false) {
//                    System.out.println("not used: " + ((VariableSymbolTableItem) s).getName() + " " + ((VariableSymbolTableItem) s).getLine());
                    f.add(s);
                }
            }
        }
